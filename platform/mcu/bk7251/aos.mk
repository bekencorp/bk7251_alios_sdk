...
$(NAME)_VERSION    := 1.0.0
$(NAME)_SUMMARY    := driver & sdk for platform/mcu bk7251
...
AOS_IMG1_XIP1_LD_FILE += platform/mcu/bk7251/bk7251.ld
AOS_IMG2_XIP2_LD_FILE += platform/mcu/bk7251/bk7251_ex.ld
else
GLOBAL_LDS_FILES += platform/mcu/bk7251/bk7251.ld
endif
...
include ./platform/mcu/bk7251/beken/beken.mk
